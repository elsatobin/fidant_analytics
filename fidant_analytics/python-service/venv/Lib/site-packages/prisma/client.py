...
SCHEMA_PATH = Path('D:/New folder (2)/fidant_analytics/python-service/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\Administrator\\.cache\\prisma-python\\binaries\\5.17.0\\393aa359c9ad4a4bb28630fb5613f9c281cde053\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    dailyusagecache: 'actions.DailyUsageCacheActions[models.DailyUsageCache]'
    ...
    def __init__(
        ...
        *,
        ...
        self.dailyusagecache = actions.DailyUsageCacheActions[models.DailyUsageCache](self, models.DailyUsageCache)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': 'D:/New folder (2)/fidant_analytics/python-service/prisma/schema.prisma',
        }
...
class Batch:
    dailyusagecache: 'DailyUsageCacheBatchActions'

    def __init__(self, client: Prisma) -> None:
        self.__client = client
        self.__queries: List[str] = []
        self._active_provider = client._active_provider
        self.dailyusagecache = DailyUsageCacheBatchActions(self)
...
class DailyUsageCacheBatchActions:
